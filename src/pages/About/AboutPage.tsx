...
export function AboutPage() {
  return (
    <div className="page about-page">
      <section className="container about-hero"><span className="eyebrow">ABOUT PLAYNEST</span><h1>给每一段空闲，<br /><em>一个舒服的去处。</em></h1><p>PlayNest 是一个无需注册即可浏览和游玩的现代中文休闲游戏平台。第一款真实游戏从基础麻将开始。</p></section>
      ...
      <section className="container about-cta"><div><span className="eyebrow">CURRENT STATUS</span><h2>巢已经搭好，第一局已经开始。</h2><p>当前拥有 1 款真实游戏：四人本地共享设备的 PlayNest 基础麻将。其他游戏仍等待逐个确认。</p></div><Link className="button button-primary" to="/games">查看平台内容 <ArrowRight size={18} /></Link></section>
    </div>
  );
}
